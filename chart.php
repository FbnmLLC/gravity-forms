...
class Ir123pay_Chart {

	// ------------------------GravityForms.IR-------------------------
	public static function stats_page() {

		if ( ! empty( $_POST ) ) {
			check_admin_referer( "search", "gf_ir123pay_chart" );
		}

		$form_id = rgget( "id" );
		$form    = RGFormsModel::get_form_meta( $form_id );
		if ( empty( $form ) || ! is_numeric( $form_id ) || intval( $form_id ) != $form_id ) {
			die( __( 'فرم درخواستی وجود ندارد.', 'gravityformsir123pay' ) );
		}
		?>
        <style type="text/css">
            .ir123pay_graph_container {
                clear: both;
                padding-left: 5px;
                min-width: 789px;
                margin-right: 50px;
            ...
            .ir123pay_summary_value {
                font-size: 20px;
                margin: 5px 0;
            }

            .ir123pay_summary_title {
                height: 40px;
            }
        ...
        <div class="wrap">
            <ul class="subsubsub">
                <li><a class="<?php echo ( ! rgget( "tab" ) || rgget( "tab" ) == "today" ) ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>"><?php _e( "امروز", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "yesterday" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=yesterday"><?php _e( "دیروز", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last7days" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last7days"><?php _e( "هفت روز گذشته", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisweek" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisweek"><?php _e( "هفته جاری", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last30days" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last30days"><?php _e( "30 روز گذشته", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thismonth" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thismonth"><?php _e( "ماه جاری", "gravityformsir123pay" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "lastmonth" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=lastmonth"><?php _e( "ماه قبل", "gravityformsir123pay" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last2month" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last2month"><?php _e( "2 ماه اخیر", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last3month" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last3month"><?php _e( "3 ماه اخیر", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last6month" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last6month"><?php _e( "6 ماه اخیر", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last9month" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last9month"><?php _e( "9 ماه اخیر", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "last12month" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=last12month"><?php _e( "یک سال اخیر", "gravityformsir123pay" ); ?></a>
                    |
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "spring" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=spring"><?php _e( "بهار", "gravityformsir123pay" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "summer" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=summer"><?php _e( "تابستان", "gravityformsir123pay" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "fall" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=fall"><?php _e( "پاییز", "gravityformsir123pay" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "winter" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=winter"><?php _e( "زمستان", "gravityformsir123pay" ); ?></a>|
                </li>
                <li><a class="<?php echo rgget( "tab" ) == "thisyear" ? "current" : "" ?>"
                       href="?page=gf_ir123pay&view=stats&id=<?php echo rgget( 'id' ) ?>&tab=thisyear"><?php _e( "امسال", "gravityformsir123pay" ); ?></a>
                </li>
                <br/><br/>
                <form method="post"
                      action="?page=gf_ir123pay&view=stats&id=<?php echo rgget( "id" ) ?>&tab=selection"><?php wp_nonce_field( "search", "gf_ir123pay_chart" ) ?>
                    <span><?php _e( 'از تاریخ', 'gravityformsir123pay' ) ?></span>
                    <input type="text" name="min" class="datepicker"
                           value="<?php echo sanitize_text_field( rgpost( 'min' ) ); ?>" autocomplete="off"/>
                    <span style="margin-right:15px"><?php _e( 'تا تاریخ', 'gravityformsir123pay' ) ?></span>
                    ...
                    <input type="submit" class="button-primary button" name="submit"
                           value="<?php _e( 'انتخاب', 'gravityformsir123pay' ) ?>"><br>
                </form>
            </ul>
            ...
            <div class="clear"></div>
            <h2><?php _e( " درآمد از درگاه یک دو سه پی برای فرمِ ", "gravityformsir123pay" ) ?><?php echo '"' . $form["title"] . '"'; ?></h2>
            <div>
				<?php if ( empty( $chart_info["series"] ) ) { ?>
                    <div class="ir123pay_message_container"><?php _e( "موردی یافت نشد . ", "gravityformsir123pay" ) ?></div>
				<?php } else { ?>
                    <div class="ir123pay_graph_container">
                        <div id="graph_placeholder" style="width:100%;height:300px;"></div>
                    </div>
					<?php
				}

				$sales_label = __( "تعداد کل پرداخت های  یک دو سه پی این فرم", "gravityformsir123pay" );

				$transaction_totals = GFIr123payData::get_transaction_totals( $form_id );
				...
				?>
                <div class="ir123pay_summary_container">
                    <div class="ir123pay_summary_item">
                        <div
                                class="ir123pay_summary_title"><?php _e( 'جمع پرداخت های  یک دو سه پی این فرم', 'gravityformsir123pay' ) ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info["revenue_label"] ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info["mid_label"] ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info["mid"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $sales_label ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $total_sales, 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info["sales_label"] ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info["midt_label"] ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info["midt"], 'fa' ) ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " درآمد از همه روش ها برای فرمِ ", "gravityformsir123pay" ) ?><?php echo '"' . $form["title"] . '"'; ?></h2>
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های  همه روش های این فرم", "gravityformsir123pay" );

				$transaction_totals = GFIr123payData::get_transaction_totals_gateways( $form_id );
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                ...
                <div class="ir123pay_summary_container">
                    ...
                    <div class="ir123pay_summary_item">
                        <div
                                class="ir123pay_summary_title"><?php _e( "جمع پرداخت های  همه روشهای این فرم", "gravityformsir123pay" ) ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_gateways["revenue_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_gateways["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_gateways["mid_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_gateways["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_gateways["sales_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_gateways["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_gateways["midt_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_gateways["midt"], 'fa' ) ?></div>
                    </div>
            ...
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " کل درآمد های یک دو سه پی", "gravityformsir123pay" ) ?></h2>
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های درگاه یک دو سه پی", "gravityformsir123pay" );

				$transaction_totals = GFIr123payData::get_transaction_totals_ir123pay();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="ir123pay_summary_container">
                    <div class="ir123pay_summary_item">
                        <div
                                class="ir123pay_summary_title"><?php _e( "جمع پرداخت های  همه فرمهای یک دو سه پی", "gravityformsir123pay" ) ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_hannan["revenue_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_hannan["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_hannan["mid_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_hannan["mid"], 'fa' ) ?></div>
                    </div>
                    ...
                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_hannan["sales_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_hannan["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_hannan["midt_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_hannan["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
            <hr>
            <div class="clear"></div>
            <h2><?php _e( " کل درآمد های سایت ( همه روش ها برای همه فرم ها)", "gravityformsir123pay" ) ?></h2>
            <div>
				...
				$sales_label = __( "تعداد کل پرداخت های همه فرمهای سایت", "gravityformsir123pay" );

				$transaction_totals = GFIr123payData::get_transaction_totals_site();
				$total_sales        = empty( $transaction_totals["active"]["transactions"] ) ? 0 : $transaction_totals["active"]["transactions"];
				$total_revenue      = empty( $transaction_totals["active"]["revenue"] ) ? 0 : $transaction_totals["active"]["revenue"];
				?>
                <div class="ir123pay_summary_container">
                    <div class="ir123pay_summary_item">
                        <div
                                class="ir123pay_summary_title"><?php _e( "جمع کل پرداخت های همه فرمهای سایت", "gravityformsir123pay" ) ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( GFCommon::to_money( $total_revenue ), 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_site["revenue_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_site["revenue"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_site["mid_label"] ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_site["mid"], 'fa' ) ?></div>
                    </div>
                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $sales_label ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $total_sales, 'fa' ) ?></div>
                    ...
                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_site["sales_label"] ?></div>
                        <div
                                class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_site["sales"], 'fa' ) ?></div>
                    </div>

                    <div class="ir123pay_summary_item">
                        <div class="ir123pay_summary_title"><?php echo $chart_info_site["midt_label"] ?></div>
                        <div class="ir123pay_summary_value"><?php echo GF_tr_num( $chart_info_site["midt"], 'fa' ) ?></div>
                    </div>
                </div>
            </div>
        </div>
        <script type="text/javascript">
            var ir123pay_graph_tooltips = <?php echo GF_tr_num( $chart_info["tooltips"], 'fa' ) ?>;
            ...
            function startShowTooltip(item) {
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        jQuery("#ir123pay_graph_tooltip").remove();
                        var x = item.datapoint[0].toFixed(2),
                            y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, ir123pay_graph_tooltips[item.dataIndex]);
                    }
                }
                else {
                    jQuery("#ir123pay_graph_tooltip").remove();
            ...
            var ir123pay_graph_tooltip1s1 = <?php echo GF_tr_num( $chart_info_hannan["tooltips"], 'fa' ) ?>;
            ...
            function startShowTooltip1(item) {
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        var x = item.datapoint[0].toFixed(2),
                            y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, ir123pay_graph_tooltip1s1[item.dataIndex]);
                    }
                }
                else {
                    jQuery("#ir123pay_graph_tooltip").remove();
            ...
            var ir123pay_graph_tooltip2s2 = <?php echo GF_tr_num( $chart_info_gateways["tooltips"], 'fa' ) ?>;
            ...
            function startShowTooltip2(item) {
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        var x = item.datapoint[0].toFixed(2),
                            y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, ir123pay_graph_tooltip2s2[item.dataIndex]);
                    }
                }
                else {
                    jQuery("#ir123pay_graph_tooltip").remove();
            ...
            var ir123pay_graph_tooltip3s3 = <?php echo GF_tr_num( $chart_info_site["tooltips"], 'fa' ) ?>;
            ...
            function startShowTooltip3(item) {
                if (item) {
                    if (!previousPoint || previousPoint[0] != item.datapoint[0]) {
                        ...
                        var x = item.datapoint[0].toFixed(2),
                            y = item.datapoint[1].toFixed(2);
                        showTooltip(item.pageX, item.pageY, ir123pay_graph_tooltip3s3[item.dataIndex]);
                    }
                }
                else {
                    jQuery("#ir123pay_graph_tooltip").remove();
            ...
            function showTooltip(x, y, contents) {
                jQuery('<div id="ir123pay_graph_tooltip">' + contents + '<div class="tooltip_tip1"></div></div>').css({
                    position: 'absolute',
                    display: 'none',
                    opacity: 1,
                    width: '150px',
	...
	public static function lastxdays_chart_info( $form_id, $chart, $x ) {
		...
		if ( $chart == 1 ) {
			...
			$t       = __( 'یک دو سه پی این فرم', 'gravityformsir123pay' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        ...
                                        WHERE form_id={$form_id} AND l.status='active' AND l.is_fulfilled=1 AND l.payment_method='ir123pay'
                                        GROUP BY date(date)
		...
		if ( $chart == 2 ) {
			...
			$t       = __( 'همه روشهای این فرم', 'gravityformsir123pay' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
		...
		if ( $chart == 3 ) {
			$c       = 'orang';
			$dt      = "}";
			$t       = __( "همه فرمهای یک دو سه پی", 'gravityformsir123pay' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
                                        WHERE l.status='active' AND l.is_fulfilled=1 AND l.payment_method='ir123pay'
                                        GROUP BY date(date)
                                        ORDER BY payment_date desc" );
		}
		...
		if ( $chart == 4 ) {
			...
			$t       = __( "همه فرمهای سایت", 'gravityformsir123pay' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
		...
		if ( ! empty( $results ) ) {
			...
			foreach ( $results as $result ) {
				...
				$sales_line = "<div class='ir123pay_tooltip_sales'><span class='ir123pay_tooltip_heading'>" . __( "تعداد پرداخت ", "gravityformsir123pay" ) . ": </span><span class='ir123pay_tooltip_value'>" . $result->new_sales . "</span></div>";

				$tooltips .= "\"<div class='tooltipbox_" . $c . "'><div class='ir123pay_tooltip_date'>" . $timeX_tooltips . "</div>{$sales_line}<div class='ir123pay_tooltip_revenue'><span class='ir123pay_tooltip_heading'>" . __( "پرداختی", "gravityformsir123pay" ) . ": </span><span class='ir123pay_tooltip_value'>" . GFCommon::to_money( $result->amount_sold ) . "</span></div></div>\",";
			}
		...
		if ( $x == 7 ) {
			$n   = __( '7 روز', 'gravityformsir123pay' );
			$mid = 7;
		}
		if ( $x == 30 ) {
			$n   = __( '30 روز', 'gravityformsir123pay' );
			$mid = 30;
		}

		$sales_label = sprintf( __( "تعداد پرداخت های %s گذشته %s", 'gravityformsir123pay' ), $n, $t );

		$midt          = $mid ? $sales_week / $mid : 0;
		$mid           = ( $mid ? GFCommon::to_money( $revenue_week / $mid ) : 0 ) . __( "در روز", 'gravityformsir123pay' );
		$midt          = number_format( $midt, 3, '.', '' ) . __( "در روز", 'gravityformsir123pay' );
		$midt_label    = sprintf( __( "میانگین تعداد پرداخت های %s گذشته %s", 'gravityformsir123pay' ), $n, $t );
		$mid_label     = sprintf( __( "میانگین پرداخت های %s گذشته %s", 'gravityformsir123pay' ), $n, $t );
		$revenue_week  = GFCommon::to_money( $revenue_week );
		$revenue_label = sprintf( __( "جمع پرداخت های %s گذشته %s", 'gravityformsir123pay' ), $n, $t );
	...
	public static function thisweek_chart_info( $form_id, $chart ) {
		...
		if ( $chart == 4 ) {
			$c       = 'red';
			$dt      = "points: { symbol: 'triangle', fillColor: '#AA4643' }, color: '#AA4643'}";
			$t       = __( "همه فرم های سایت", 'gravityformsir123pay' );
			$results = $wpdb->get_results( "SELECT CONVERT_TZ(l.payment_date, '+00:00', '{$tz_offset}') as date, sum(l.payment_amount) as amount_sold, count(l.id) as new_sales
                                        FROM {$wpdb->prefix}rg_lead l
                                        WHERE l.status='active' AND l.is_fulfilled=1
                                        GROUP BY date(date)
		...
		$sales_label = __( "تعداد پرداخت های  این هفته ", 'gravityformsir123pay' ) . $t;

		$midt          = $sales_week / 7;
		$midt          = ( $midt ? number_format( $midt, 3, '.', '' ) : 0 ) . __( " در روز", 'gravityformsir123pay' );
		$midt_label    = __( "میانگین تعداد پرداخت های  این هفته ", 'gravityformsir123pay' ) . $t;
		$mid           = GFCommon::to_money( $revenue_week / 7 ) . __( " در روز", 'gravityformsir123pay' );
		$mid_label     = __( "میانگین پرداخت های این هفته ", 'gravityformsir123pay' ) . $t;
		$revenue_week  = GFCommon::to_money( $revenue_week );
		$revenue_label = __( "جمع پرداخت های  این هفته ", 'gravityformsir123pay' ) . $t;
	...
	public static function targetmdays_chart_info( $form_id, $chart, $xmonth ) {
		...
		if ( ! empty( $results ) ) {
			...
			if ( $xmonth == 1 || $xmonth == 2 ) {
				...
				$n = $n . __( " ماه", "gravityformsir123pay" );
			}
			if ( $xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12 ) {
				...
				$n = $n . __( " ماه اخیر", "gravityformsir123pay" );

				if ( $xmonth == 12 ) {
					$n = __( " یکسال اخیر", "gravityformsir123pay" );
				}
			}
		...
		if ( $xmonth == 60 || $xmonth == 3 || $xmonth == 6 || $xmonth == 9 || $xmonth == 12 ) {
			...
			if ( $xmonth == 12 ) {
				$n = __( 'یک سال اخیر', 'gravityformsir123pay' );
			}
		}

		$sales_label = __( 'تعداد پرداخت های  ', 'gravityformsir123pay' ) . $n . ' ' . $t;
		...
		$midt             = number_format( $midt, 3, '.', '' ) . __( " در روز", 'gravityformsir123pay' );
		$midt_label       = __( 'میانگین تعداد پرداخت های ', 'gravityformsir123pay' ) . $n . ' ' . $t;
		$mid              = ( $midd ? GFCommon::to_money( $revenue_thistday / $midd ) : 0 ) . __( " در روز", 'gravityformsir123pay' );
		$mid_label        = __( 'میانگین پرداخت های ', 'gravityformsir123pay' ) . $n . ' ' . $t;
		$revenue_label    = __( 'جمع پرداخت های  ', 'gravityformsir123pay' ) . $n . ' ' . $t;
	...
	public static function tyday_chart_info( $form_id, $chart, $day ) {
		...
		$date          = new DateTime( $today );
		if ( $day == 1 ) {
			$n    = __( "امروز", 'gravityformsir123pay' );
			$baze = date( 'm d , Y', $tday );
			$ty   = date( 'Ymd', $tday );
		} else if ( $day == 2 ) {
			$n = __( "دیروز", 'gravityformsir123pay' );
			$date->sub( new DateInterval( 'P1DT0H0M' ) );
		...
		$midt          = $sales_today / 24;
		$midt          = number_format( $midt, 3, '.', '' ) . __( " در ساعت", "gravityformsir123pay" );
		$midt_label    = __( "میانگین تعداد پرداخت های ", "gravityformsir123pay" ) . $n . " " . $t;
		$mid           = GFCommon::to_money( $revenue_today / 24 ) . __( " در ساعت", "gravityformsir123pay" );
		$mid_label     = __( "میانگین پرداخت های ", "gravityformsir123pay" ) . $n . " " . $t;
	...
	public static function yearly_chart_info( $form_id, $chart ) {
		...
		$sales_label = __( "تعداد پرداخت های امسال ", "gravityformsir123pay" ) . $t;
		...
		$midt           = number_format( $midt, 3, '.', '' ) . __( " در روز", "gravityformsir123pay" );
		$midt_label     = __( "میانگین تعداد پرداخت های امسال ", "gravityformsir123pay" ) . $t;
		$mid            = ( $midd ? GFCommon::to_money( $revenue_yearly / $midd ) : 0 ) . __( " در روز", "gravityformsir123pay" );
		$mid_label      = __( "میانگین پرداخت های امسال ", "gravityformsir123pay" ) . $t;
		$revenue_yearly = GFCommon::to_money( $revenue_yearly );
		$revenue_label  = __( "جمع پرداخت های امسال ", "gravityformsir123pay" ) . $t;
	...
	public static function season_chart_info( $form_id, $chart, $season ) {
		...
		if ( $season == 1 ) {
			$n      = __( 'بهار', 'gravityformsir123pay' );
			$ebtda  = $avalesal_t;
		...
		if ( $season == 2 ) {
			$n      = __( 'تابستان', 'gravityformsir123pay' );
			$ebtda  = $avalesal_t;
		...
		if ( $season == 3 ) {
			$n      = __( 'پاییز', 'gravityformsir123pay' );
			$ebtda  = $avalesal_t;
		...
		if ( $season == 4 ) {
			$n      = __( 'زمستان', 'gravityformsir123pay' );
			$ebtda  = $avalesal_t;
		...
		$midt           = ( $midt ? number_format( $midt, 3, '.', '' ) : 0 ) . __( " در روز", 'gravityformsir123pay' );
		$midt_label     = __( "میانگین تعداد پرداخت های  ", 'gravityformsir123pay' ) . $n . " " . $t;
		$mid            = ( $midd ? GFCommon::to_money( $revenue_season / $midd ) : 0 ) . __( " در روز", 'gravityformsir123pay' );
		$mid_label      = __( "میانگین پرداخت های  ", 'gravityformsir123pay' ) . $n . " " . $t;
		$revenue_label  = __( "جمع پرداخت های  ", 'gravityformsir123pay' ) . $n . " " . $t;
	...
	public static function selection_chart_info( $form_id, $chart, $min, $max ) {
		...
		$sales_label = __( "تعداد پرداخت های بازه انتخابی ", 'gravityformsir123pay' ) . $t;

		$midt          = $midd ? $sales_today / $midd : 0;
		$midt          = number_format( $midt, 3, '.', '' ) . __( " در روز", 'gravityformsir123pay' );
		$midt_label    = __( "میانگین تعداد پرداخت های  ", 'gravityformsir123pay' ) . $t . "";
		$mid           = ( $midd ? GFCommon::to_money( $revenue_today / $midd ) : 0 ) . __( " در روز", 'gravityformsir123pay' );
		$mid_label     = __( "میانگین پرداخت های  ", 'gravityformsir123pay' ) . $t . "";
		$revenue_today = GFCommon::to_money( $revenue_today );
		$revenue_label = __( "جمع پرداخت های بازه انتخابی ", 'gravityformsir123pay' ) . $t;
